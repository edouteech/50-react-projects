    ...
    return (
        <div>
            <div className="flex space-x-4 md:mb-4">
                ...
                <button onClick={() => setStatusMatch("FINISHED")} className={`px-2 py-1 text-primary text-xs md:text-sm rounded-md ${statusMatch === 'FINISHED' ? 'bg-teal-400 font-semibold' : 'bg-slate-500 font-regular'}`}>finished</button>
            </div>
